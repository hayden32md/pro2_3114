...
public class DNAProjTest extends TestCase {
    ...
    public void testMilestone1Coverage() {
        assertNull(it.insert("ACGT"));
        assertNull(it.remove("ACGT"));
        assertNull(it.search("ACGT"));
        assertNull(it.print());
        assertNull(it.printLengths());
        assertNull(it.printStats());
    }
}
